...
import aigilityxLogo from "../../assets/marquee/AIgilityX.png";
...
const IndustriesMarqueeSection: React.FC = () => {
  ...
  return (
    <section className="industries pos-rel pt-145 pb-50 bg_img" style={{ overflow: 'hidden' }}>
          ...
          <div className="col-xl-6 col-lg-8">
            <div className="xb-industries-wrapper">
              ...
              <div className="xb-industries-logo wow zoomIn">
                <img src={aigilityxLogo} alt="logo" />
              </div>
            </div>
          </div>
        </div>
